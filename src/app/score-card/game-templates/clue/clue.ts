...
// A simple Clue scoring template — flexible labels for tracking points per category
export const labels = [
  'Suspects',
  'Weapons',
  'Rooms',
...
export function isClueCard(card?: ScoreCard | null) {
...
export function computeDerivedTotals(card?: ScoreCard | null): Record<string, number> {
  // No derived totals for Clue yet
